...
const jobCategories_router_1 = __importDefault(require("./jobCategories.router"));
const productCombo_router_1 = __importDefault(require("./productCombo.router"));
const cfStock_router_1 = __importDefault(require("./cfStock.router"));
...
router.use("/jobCategory", jobCategories_router_1.default);
router.use("/productComboOffer", productCombo_router_1.default);
router.use("/shop", shop_router_1.default);
router.use("/stock", cfStock_router_1.default);
